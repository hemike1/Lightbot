...
b.WhileInstruction;lightBot.bot.instructions=b})();(function(){var a={},b=[{direction:0,position:{x:4,y:5},map:[[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],[{h:2,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:2,t:"b"}],
...
{h:2,t:"b"},{h:1,t:"b"}],[{h:1,t:"b"},{h:2,t:"b"},{h:3,t:"b"},{h:4,t:"l"},{h:3,t:"b"},{h:2,t:"b"},{h:1,t:"b"}],[{h:1,t:"b"},{h:2,t:"b"},{h:3,t:"l"},{h:3,t:"b"},{h:3,t:"l"},{h:2,t:"b"},{h:1,t:"b"}],[{h:1,t:"b"},{h:2,t:"l"},{h:2,t:"b"},{h:2,t:"b"},{h:2,t:"b"},{h:2,t:"l"},{h:1,t:"b"}],[{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"},{h:1,t:"b"}]],medals:{gold:10,silver:32,bronze:43}}],d={x:0,y:0},c=null,g=null,j=null;a.loadMap=function(a){if(b){j=a;lightBot.bot.init(b[a].direction,
...
c[f][b.map.length-h-1]=new lightBot.Box(b[a].map[h][f].h,f,b[a].map.length-h-1)}i===0&&console.error("No light defined in map")}else console.error("Map list is empty")};a.reset=function(){lightBot.bot.reset();for(var a=0;a<d.x;a++)for(var b=0;b<d.y;b++)c[a][b].reset()};a.ready=function(){return j!==null};a.getLevelSize=function(){return d};a.getMapRef=function(){return c};a.getMedals=function(){return g};a.getLevelNumber=function(){return j};a.getNbrOfLevels=function(){return b.length};a.complete=
function(){j=null};lightBot.map=a})();(function(){lightBot.map.state={allLightsOn:function(){for(var a=0;a<lightBot.map.getLevelSize().x;a++)for(var b=0;b<lightBot.map.getLevelSize().y;b++)if(lightBot.map.getMapRef()[a][b]instanceof lightBot.LightBox&&!lightBot.map.getMapRef()[a][b].lightOn)return false;return true},check:function(a){return a()}}})();(function(){lightBot.Box=function(a,b,d){this.height=a;this.x=b;this.y=d;this.reset=function(){}}})();(function(){function a(a,d,c){this.lightOn=false;this.height=a;this.x=d;this.y=c;this.toggleLight=function(){this.lightOn=!this.lightOn};this.reset=function(){this.lightOn=false}}a.prototype=new lightBot.Box;a.prototype.constructor=a;lightBot.LightBox=a})();(function(){lightBot.medals={gold:4,silver:3,bronze:2,noMedal:1,awardMedal:function(){var a=lightBot.bot.getNumberOfInstructions(),b=lightBot.map.getMedals(),d=this.noMedal;if(a<=b.gold)d=this.gold;else if(a<=b.silver)d=this.silver;else if(a<=b.bronze)d=this.bronze;(!localStorage.getItem("lightbot_level_"+lightBot.map.getLevelNumber())||parseInt(localStorage.getItem("lightbot_level_"+lightBot.map.getLevelNumber()),10)<d)&&localStorage.setItem("lightbot_level_"+lightBot.map.getLevelNumber(),d);return d}}})();(function(){function a(){for(var a=0,b=0;b<lightBot.map.getNbrOfLevels();b++)localStorage.getItem("lightbot_level_"+b)&&a++;return a}function b(a){for(var b=0,g=0;g<lightBot.map.getNbrOfLevels();g++)localStorage.getItem("lightbot_level_"+g)&&parseInt(localStorage.getItem("lightbot_level_"+g),10)>=a&&b++;return b}lightBot.achievements={achievementsList:[{name:"lightbot_achievement_complete_level",title:"Kivégezve!",message:"Csinálj meg egy pályát",check:function(){return true}},{name:"lightbot_achievement_earn_gold_medal",
title:"Aranyos",message:"Kapj egy arany medált.",check:function(){return lightBot.bot.getNumberOfInstructions()<=lightBot.map.getMedals().gold?true:false}},{name:"lightbot_achievement_complete_levels_5",title:"Törekvő",message:"Teljesíts 5 szintet.",check:function(){return a()>=5?true:false}},{name:"lightbot_achievement_complete_levels_10",title:"Elkötelezett",message:"Teljesíts 10 szintet.",check:function(){return a()>=10?true:false}},{name:"lightbot_achievement_complete_levels_15",title:"Függő",message:"Teljesíts 15 szintet.",
check:function(){return a()>=15?true:false}},{name:"lightbot_achievement_complete_levels_bronze",title:"Stréber",message:"Érj el legalább bronz medált minden szinten.",check:function(){return b(lightBot.medals.bronze)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_silver",title:"Elit!",message:"Érj el legalább ezüst medált minden szinten.",check:function(){return b(lightBot.medals.silver)===lightBot.map.getNbrOfLevels()}},{name:"lightbot_achievement_complete_levels_gold",title:"Hekker",message:"Érj el legalább arany medált minden szinten.",
...
$(this).button("option",{label:"Futtatás",icons:{primary:"ui-icon-play"}}).removeClass("ui-state-highlight");else{var a=lightBot.ui.editor.getInstructions($("#programContainer > div > ul > li"));lightBot.bot.queueInstructions(a);lightBot.bot.execute();$(this).button("option",{label:"Leállít",icons:{primary:"ui-icon-stop"}}).addClass("ui-state-highlight")}});$("#clearButton").button({icons:{primary:"ui-icon-document"}}).click(function(){$("#programContainer ul").empty();lightBot.ui.editor.saveProgram()});
